...
⛔ ${Object.entries(global.db.data.users).filter(user => user[1].banned).length} Pengguna Terbanned\`\`\`
          ...
          "sections": [
                            {
                                "rows": [{
                                         "title": "📊 › Status",
                                         "description": "Status XiaoWu-Bot",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed",
                                         "description": "Menampilkan Kecepatan Respon XiaoWu-Bot",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info",
                                         ...
                                         "title": "🪙 › Leaderboard",
                                         "description": "Check Ranked",
                                         "rowId": ".lb"  
                                    }, {
                                         "title": "💌 › Group Bot",
                                         "description": "Join Ke Grup Official XiaoWu-Bot",
                                         "rowId": ".gcbot" 
                                    }, {
                                         "title": "🦄 › Group Setting",
                                         ...
                                         "title": "🤖 › Bot Setting",
                                         "description": "Setting Bot XiaoWu-Bot",
                                         "rowId": ".botsett" 
                  ...
                  "rowId": ".? owner"
                                ...
                                "rows": [{
                                "title": "🗳️  » Donasi «",
                                "description": "Donasi Kak, Terimakasih",
                                "rowId": ".donasi"
                                }, {
                                "title": "🔖 » Sewa «",
                                ...
                                "title": "🎖️ » Thanks To «",
                                "description": "Terima kasih banyak untuk user yang telah berpartisipasi dalam XiaoWu-Bot",
                                "rowId": ".? thnks"
                                }, {
    ...
    // await conn.send3ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'XiaoWu-Bot', 'Creator', '.creator', 'Donasi', '.donasi', 'Rules', '.infobot', m)
