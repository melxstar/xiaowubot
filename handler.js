...
"headerType": "DOCUMENT", "documentMessage": {
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, 'XiaoWu-Bot', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
let fot = `Made by @${'6281212303461'.split('@')[0]}`
  let msg = {
    rowner: '*CREATOR ONLY*',
    owner: '*OWNER ONLY*',
    mods: '*MODERATOR ONLY*',
          ...
          "sections": [
          
                            {
                                ...
                                "rows": [{
                                         ...
                                         "description": "Menampilkann Kecepatan Respon XiaoWu-Bot",
                  ...
                  "rows": [{                               
                                         ...
                                         "title": '27 Tahun',
                                         "description": "XiaoWu-Bot Is The Best ❤️",
